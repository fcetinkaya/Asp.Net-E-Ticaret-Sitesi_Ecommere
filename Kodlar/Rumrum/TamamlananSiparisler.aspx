<%@ Page Title="" Language="C#" MasterPageFile="~/Rumrum/MasterPage.master" AutoEventWireup="true" CodeFile="TamamlananSiparisler.aspx.cs" Inherits="Rumrum_TamamlananSiparisler" %>
        ...
        <ContentTemplate>
            <section id="main" class="column">
                ...
                <article class="module width_full">
                    <header>
                        <h3>tamamlanan siparişler listesi {<asp:Label ID="ToplamAdetLbl" runat="server"></asp:Label>}</h3>
                    </header>
