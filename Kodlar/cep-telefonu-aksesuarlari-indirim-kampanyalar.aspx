<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="cep-telefonu-aksesuarlari-indirim-kampanyalar.aspx.cs" Inherits="cep_telefonu_aksesuarlari_indirim_kampanyalar" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="UrunListeBaslikDiv">
        <div class="UrunListeBaslik_OrtaCizgiDiv">
            <div class="UrunListeBaslik_SolKisimDiv">
                <div class="UrunListeBaslik_SolKisimYaziDiv">
                    Kampanyalı / İndirimli Koruyucu Filmler
                </div>
            </div>
            <div class="UrunListeBaslik_SagKisimDiv">
                <div class="UrunListeBaslik_SagKisimYaziDiv">
    ...
    <div class="UrunListeBaslikDiv">
        <div class="UrunListeBaslik_OrtaCizgiDiv">
            <div class="UrunListeBaslik_SolKisimDiv">
                <div class="UrunListeBaslik_SolKisimYaziDiv">
                    Kampanyalı / İndirimli Kulaklıklar
                </div>
            </div>
            <div class="UrunListeBaslik_SagKisimDiv">
                <div class="UrunListeBaslik_SagKisimYaziDiv">
    ...
    <div class="UrunListeBaslikDiv">
        <div class="UrunListeBaslik_OrtaCizgiDiv">
            <div class="UrunListeBaslik_SolKisimDiv">
                <div class="UrunListeBaslik_SolKisimYaziDiv">
                    Kampanyalı / İndirimli Şarj Aletleri
                </div>
            </div>
            <div class="UrunListeBaslik_SagKisimDiv">
                <div class="UrunListeBaslik_SagKisimYaziDiv">
    ...
    <div class="UrunListeBaslikDiv">
        <div class="UrunListeBaslik_OrtaCizgiDiv">
            <div class="UrunListeBaslik_SolKisimDiv">
                <div class="UrunListeBaslik_SolKisimYaziDiv">
                    Kampanyalı / İndirimli Kablo ve Dönüştürücüler
                </div>
            </div>
            <div class="UrunListeBaslik_SagKisimDiv">
                <div class="UrunListeBaslik_SagKisimYaziDiv">
