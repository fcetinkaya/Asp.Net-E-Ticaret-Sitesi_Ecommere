<%@ Page Title="" Language="C#" MasterPageFile="~/Rumrum/MasterPage.master" AutoEventWireup="true" CodeFile="UrunSilme.aspx.cs" Inherits="Rumrum_UrunSilme" %>
    ...
    <section id="main" class="column">
        <asp:UpdatePanel ID="UpdatePanel1" runat="server">
            <ContentTemplate>
                ...
                <article id="Arama_Article" runat="server" class="module width_full">
                    <header>
                        <h3>ürün arama</h3>
                    </header>
                ...
                <article id="Details" class="module width_full" runat="server" visible="false">
                    ...
                    <div class="module_content" style="height: auto;">
                        ...
                        <footer>
                            <div class="submit_link">
                                <asp:Button ID="SilBtn" runat="server" Text="Ürünü Sil" CssClass="butoncuk" OnClick="SilBtn_Click" />
