<%@ Page Title="" Language="C#" MasterPageFile="~/Rumrum/MasterPage.master" AutoEventWireup="true" CodeFile="UrunDuzenleme.aspx.cs" Inherits="Rumrum_UrunDuzenleme" %>
            ...
            <ContentTemplate>
                ...
                <article id="Details" class="module width_full" runat="server" visible="false">
                    ...
                    <div class="module_content" style="height: auto;">
                        ...
                        <footer>
                            <div class="submit_link">
                                <asp:Button ID="DuzenleBtn" runat="server" Text="Ürünü Düzenle" CssClass="alt_btn" OnClick="DuzenleBtn_Click" />
                            </div>
                        </footer>
                        <br />
                        <br />
