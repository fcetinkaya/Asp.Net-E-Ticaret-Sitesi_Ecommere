<%@ Page Title="" Language="C#" MasterPageFile="~/Rumrum/MasterPage.master" AutoEventWireup="true" CodeFile="StokdaKalmayanListesi.aspx.cs" Inherits="Rumrum_StokdaKalmayanListesi" %>
                                    ...
                                    <asp:GridView ID="Urunler_Grid" runat="server" AutoGenerateColumns="False" AllowPaging="True" PageSize="25" OnPageIndexChanging="Urunler_Grid_PageIndexChanging" DataKeyNames="UrunID" CssClass="Gridview" ShowHeader="false" OnRowDataBound="Urunler_Grid_RowDataBound" OnRowCommand="Urunler_Grid_RowCommand">
                                        <Columns>
                                            ...
                                            <asp:TemplateField ItemStyle-Width="120px">
                                                <ItemTemplate>
                                                    <asp:ImageButton ID="SatisYapilamayacakBtn" runat="server" ImageUrl="~/Rumrum/images/geri_don.png"
                                                        ToolTip="Ürün Stokta Var" CommandArgument='<%# Eval("UrunID")%>' CommandName="GeriAl"></asp:ImageButton>
