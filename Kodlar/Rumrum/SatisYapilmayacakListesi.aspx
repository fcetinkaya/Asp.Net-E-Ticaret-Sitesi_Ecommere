<%@ Page Title="" Language="C#" MasterPageFile="~/Rumrum/MasterPage.master" AutoEventWireup="true" CodeFile="SatisYapilmayacakListesi.aspx.cs" Inherits="Rumrum_SatisYapilmayacakListesi" %>
                                            ...
                                            <asp:TemplateField ItemStyle-Width="120px">
                                                <ItemTemplate>
                                                    <asp:ImageButton ID="SatisYapilamayacakBtn" runat="server" ImageUrl="~/Rumrum/images/geri_don.png"
                                                        ToolTip="Satış Yap" CommandArgument='<%# Eval("UrunID")%>' CommandName="GeriAl">
                                                    </asp:ImageButton>
