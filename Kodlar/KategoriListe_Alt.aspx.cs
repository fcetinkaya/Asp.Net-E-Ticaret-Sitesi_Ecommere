...
public partial class KategoriListe_Alt : System.Web.UI.Page
{
    cls_KategoriListe_Alt Kat_Cls = new cls_KategoriListe_Alt();
    cls_Urunler_CokSatanlar Urun_Cls = new cls_Urunler_CokSatanlar();
    SqlConnection con = new SqlConnection();
    private static string GelenID, Secim, SeciliTelefonID, SeciliModelID;
    public int SayfaNo
    {
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            try
            {
                if (RouteData.Values["KateAdi"] != null)
                {
                    TelefonMarkaGetir();
                    string Raute = RouteData.Values["KateAdi"].ToString();
                    string[] GelKAt = Kat_Cls.KategorilerBilgisiGetir(Raute);
                    GelenID = GelKAt[0].ToString();
                    CokSatanLbl.Text = GelKAt[1].ToString().Trim();
                    KategoriAdiLbl.Text = GelKAt[1].ToString().Trim();
                    ...
                    KategoriyeGore_Getir_Urunleri(GelenID);
                    EnCokSatanlar();
    ...
    private void KategoriyeGore_Getir_Urunleri(string GelenAydi)
    {
        Secim = "IlkGelen";
        KategoriRepeater.Visible = true;
        UyariDiv.Visible = false;
        Sayfa = new PagedDataSource();
        DataTable dt = Kat_Cls.RouteID_GoreGetir_Urunleri(GelenAydi);
        if (dt.Rows.Count != 0)
        {
    ...
    {
        DataTable dt = Kat_Cls.EnCokSatanlar(GelenID);
        if (dt.Rows.Count != 0)
        {
    ...
    private void FiyatArtana_Gore_Getir_Urunleri(string GelenAydi)
    {
        Secim = "Fiyat_Artan";
        Sayfa = new PagedDataSource();
        KategoriRepeater.Visible = true;
        ...
        DataTable dt = Kat_Cls.FiyatArtana_GoreGetir_Urunleri(GelenAydi);
        if (dt.Rows.Count != 0)
        {
            Sayfa.DataSource = dt.DefaultView;
            Sayfa.AllowPaging = true;
    ...
    private void FiyatAzalana_Gore_Getir_Urunleri(string GelenAydi)
    {
        Secim = "Fiyat_Azalan";
        Sayfa = new PagedDataSource();
        KategoriRepeater.Visible = true;
        UyariDiv.Visible = false;
        KategoriRepeater.DataSource = null;
        DataTable dt = Kat_Cls.FiyatAzalan_GoreGetir_Urunleri(GelenAydi);
        if (dt.Rows.Count != 0)
        {
            Sayfa.DataSource = dt.DefaultView;
            Sayfa.AllowPaging = true;
    ...
    private void AdanZyeGore_Getir_Urunleri(string GelenAydi)
    {
        Secim = "AdanZye";
        Sayfa = new PagedDataSource();
        KategoriRepeater.Visible = true;
        UyariDiv.Visible = false;
        KategoriRepeater.DataSource = null;
        DataTable dt = Kat_Cls.AdanZye_GoreGetir_Urunleri(GelenAydi);
        if (dt.Rows.Count != 0)
        {
            Sayfa.DataSource = dt.DefaultView;
            Sayfa.AllowPaging = true;
    ...
    private void ZdenAyaGore_Getir_Urunleri(string GelenAydi)
    {
        Secim = "ZdenAya";
        KategoriRepeater.DataSource = null;
        KategoriRepeater.Visible = true;
        UyariDiv.Visible = false;
        Sayfa = new PagedDataSource();
        DataTable dt = Kat_Cls.ZdenAya_GoreGetir_Urunleri(GelenAydi);
        if (dt.Rows.Count != 0)
        {
            Sayfa.DataSource = dt.DefaultView;
            Sayfa.AllowPaging = true;
    ...
    private void Telefon_Gore_Getir_Urunleri()
    {
        ...
        UyariDiv.Visible = false;
        KategoriRepeater.DataSource = null;
        DataTable dt = Kat_Cls.Telefona_GoreGetir_Urunleri(GelenID, SeciliTelefonID);
        if (dt.Rows.Count != 0)
        {
            KategoriRepeater.Visible = true;
            UyariDiv.Visible = false;
    ...
    private void TelefonModele_Gore_Getir_Urunleri()
    {
        ...
        UyariDiv.Visible = false;
        Sayfa = new PagedDataSource();
        DataTable dt = Kat_Cls.Telefon_Modele_GoreGetir_Urunleri(GelenID, SeciliModelID);
        if (dt.Rows.Count != 0)
        {
            KategoriRepeater.Visible = true;
            UyariDiv.Visible = false;
    ...
    protected void AlfabetikDrop_SelectedIndexChanged(object sender, EventArgs e)
    {
        try
        {
            ...
            {
                AdanZyeGore_Getir_Urunleri(GelenID);
            }
            else if (AlfabetikDrop.SelectedValue == "2")
            {
                ZdenAyaGore_Getir_Urunleri(GelenID);
            }
        }
        catch (Exception)
        {
    ...
    protected void FiyatDrop_SelectedIndexChanged(object sender, EventArgs e)
    {
        try
        {
            ...
            {
                FiyatAzalana_Gore_Getir_Urunleri(GelenID);
            }
            else if (FiyatDrop.SelectedValue == "2")
            {
                FiyatArtana_Gore_Getir_Urunleri(GelenID);
            }
        }
        catch (Exception)
        {
    ...
    protected void KampanyaEpostaBtn_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            if (Session["E_ticaretim"] != null)
            {
                string Aciklama = RouteData.Values["KateAdi"].ToString() + " Kategorisi için Talep Var.";
