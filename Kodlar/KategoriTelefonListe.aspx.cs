...
public partial class KategoriTelefonListe : System.Web.UI.Page
{
    cls_KategoriTelefonListe Kat_Cls = new cls_KategoriTelefonListe();
    cls_Urunler_CokSatanlar Urun_Cls = new cls_Urunler_CokSatanlar();
    SqlConnection con = new SqlConnection();
    private static string GelenKatID, GelenTelefonID, GelenAnaKatID, GelenAnaTelefonID, Secim;
    public int SayfaNo
    {
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            if (!IsPostBack)
            {
                if (RouteData.Values["KatAdi"] != null)
                {
                    string RauteKAt = RouteData.Values["KatAdi"].ToString();
                    string RauteTlf = RouteData.Values["TlfAdi"].ToString();
                    string[] GelKAt = Kat_Cls.Kategori_Telefon_BilgisiGetir(RauteKAt, RauteTlf);
                    if (!string.IsNullOrEmpty(GelKAt[0].ToString()))
                    {
                        GelenKatID = GelKAt[0].ToString();
                        GelenTelefonID = GelKAt[2].ToString();
                        CokSatanLbl.Text = GelKAt[3].ToString() + " " + GelKAt[1].ToString().Trim();
                        KategoriAdiLbl.Text = GelKAt[3].ToString() + " " + GelKAt[1].ToString().Trim();
                        KategoriyeGore_Getir_Urunleri();
                        EnCokSatanlar(GelenTelefonID, GelenKatID);
                    }
                    else
                    {
                        string[] Gel_ana_KAt = Kat_Cls.Ana_Kategori_Telefon_BilgisiGetir(RauteKAt, RauteTlf);
                        GelenAnaKatID = Gel_ana_KAt[0].ToString();
                        GelenAnaTelefonID = Gel_ana_KAt[2].ToString();
                        CokSatanLbl.Text = Gel_ana_KAt[3].ToString() + " " + Gel_ana_KAt[1].ToString().Trim();
                        KategoriAdiLbl.Text = Gel_ana_KAt[3].ToString() + " " + Gel_ana_KAt[1].ToString().Trim();
                        AnaKategoriyeGore_Getir_Urunleri();
                        EnCokSatanlar(GelenAnaTelefonID, GelenAnaKatID);
                    }
    ...
    private void KategoriyeGore_Getir_Urunleri()
    {
        ...
        DataTable dt = Kat_Cls.RouteID_GoreGetir_Urunleri(GelenTelefonID, GelenKatID);
        if (dt.Rows.Count != 0)
        {
    ...
    private void AnaKategoriyeGore_Getir_Urunleri()
    {
        Secim = "AnaIlkGelen";
        KategoriRepeater.Visible = true;
        UyariDiv.Visible = false;
        Sayfa = new PagedDataSource();
        DataTable dt = Kat_Cls.AnaRouteID_GoreGetir_Urunleri(GelenAnaTelefonID, GelenAnaKatID);
        if (dt.Rows.Count != 0)
        {
            Sayfa.DataSource = dt.DefaultView;
            Sayfa.AllowPaging = true;
    ...
    private void EnCokSatanlar(string _TlfID, string _KatID)
    {
        DataTable dt = Kat_Cls.EnCokSatanlar(_TlfID, _KatID);
        if (dt.Rows.Count != 0)
        {
    ...
    private void FiyatArtana_Gore_Getir_Urunleri()
    {
        ...
        DataTable dt = Kat_Cls.FiyatArtana_GoreGetir_Urunleri(GelenTelefonID, GelenKatID);
        if (dt.Rows.Count != 0)
        {
            Sayfa.DataSource = dt.DefaultView;
            Sayfa.AllowPaging = true;
    ...
    private void FiyatAzalana_Gore_Getir_Urunleri()
    {
        ...
        UyariDiv.Visible = false;
        KategoriRepeater.DataSource = null;
        DataTable dt = Kat_Cls.FiyatAzalan_GoreGetir_Urunleri(GelenTelefonID, GelenKatID);
        if (dt.Rows.Count != 0)
        {
            Sayfa.DataSource = dt.DefaultView;
            Sayfa.AllowPaging = true;
    ...
    private void AnaFiyatArtana_Gore_Getir_Urunleri()
    {
        Secim = "AnaFiyat_Artan";
        Sayfa = new PagedDataSource();
        KategoriRepeater.Visible = true;
        UyariDiv.Visible = false;
        KategoriRepeater.DataSource = null;
        DataTable dt = Kat_Cls.AnaFiyatArtana_GoreGetir_Urunleri(GelenAnaTelefonID, GelenAnaKatID);
        if (dt.Rows.Count != 0)
        {
            Sayfa.DataSource = dt.DefaultView;
            Sayfa.AllowPaging = true;
    ...
    private void AnaFiyatAzalana_Gore_Getir_Urunleri()
    {
        Secim = "AnaFiyat_Azalan";
        Sayfa = new PagedDataSource();
        KategoriRepeater.Visible = true;
        UyariDiv.Visible = false;
        KategoriRepeater.DataSource = null;
        DataTable dt = Kat_Cls.AnaFiyatAzalan_GoreGetir_Urunleri(GelenAnaTelefonID, GelenAnaKatID);
        if (dt.Rows.Count != 0)
        {
            Sayfa.DataSource = dt.DefaultView;
            Sayfa.AllowPaging = true;
    ...
    private void AdanZyeGore_Getir_Urunleri()
    {
        ...
        UyariDiv.Visible = false;
        KategoriRepeater.DataSource = null;
        DataTable dt = Kat_Cls.AdanZye_GoreGetir_Urunleri(GelenTelefonID, GelenKatID);
        if (dt.Rows.Count != 0)
        {
            Sayfa.DataSource = dt.DefaultView;
            Sayfa.AllowPaging = true;
    ...
    private void ZdenAyaGore_Getir_Urunleri()
    {
        ...
        UyariDiv.Visible = false;
        Sayfa = new PagedDataSource();
        DataTable dt = Kat_Cls.ZdenAya_GoreGetir_Urunleri(GelenTelefonID, GelenKatID);
        if (dt.Rows.Count != 0)
        {
            Sayfa.DataSource = dt.DefaultView;
            Sayfa.AllowPaging = true;
    ...
    private void AnaAdanZyeGore_Getir_Urunleri()
    {
        Secim = "AnaAdanZye";
        Sayfa = new PagedDataSource();
        KategoriRepeater.Visible = true;
        UyariDiv.Visible = false;
        KategoriRepeater.DataSource = null;
        DataTable dt = Kat_Cls.AnaAdanZye_GoreGetir_Urunleri(GelenAnaTelefonID, GelenAnaKatID);
        if (dt.Rows.Count != 0)
        {
            Sayfa.DataSource = dt.DefaultView;
            Sayfa.AllowPaging = true;
    ...
    private void AnaZdenAyaGore_Getir_Urunleri()
    {
        Secim = "AnaZdenAya";
        KategoriRepeater.DataSource = null;
        KategoriRepeater.Visible = true;
        UyariDiv.Visible = false;
        Sayfa = new PagedDataSource();
        DataTable dt = Kat_Cls.AnaZdenAya_GoreGetir_Urunleri(GelenAnaTelefonID, GelenAnaKatID);
        if (dt.Rows.Count != 0)
        {
            Sayfa.DataSource = dt.DefaultView;
            Sayfa.AllowPaging = true;
    ...
    protected void FiyatDrop_SelectedIndexChanged(object sender, EventArgs e)
    {
        try
        {
            ...
            {
                if (Secim == "AnaFiyat_Azalan")
                {
                    AnaFiyatAzalana_Gore_Getir_Urunleri();
                }
                else
                {
            ...
            {
                if (Secim == "AnaFiyat_Artan")
                {
                    AnaFiyatArtana_Gore_Getir_Urunleri();
                }
                else
                {
    ...
    protected void KampanyaEpostaBtn_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            if (Session["E_ticaretim"] != null)
            {
                string Aciklama = RouteData.Values["TlfAdi"].ToString() + "/" + RouteData.Values["KatAdi"].ToString() + " Kategorisi için Talep Var.";
