<%@ Page Title="" Language="C#" MasterPageFile="~/Rumrum/MasterPage.master" AutoEventWireup="true" CodeFile="SatisYapilmayacakUrunler.aspx.cs" Inherits="Rumrum_SatisYapilmayacakUrunler" %>
                ...
                <article id="Details" class="module width_full" runat="server" visible="false">
                    ...
                    <div class="module_content" style="height: auto;">
                        <fieldset>
                            ...
                            <label class="labelfiel" style="width: 450px;">
                        ...
                        <footer>
                            <div class="submit_link">
                                <asp:Button ID="DuzenleBtn" runat="server" Text="Ürünü Onayla" CssClass="alt_btn" OnClick="DuzenleBtn_Click" />
                            </div>
                        </footer>
                        <br />
                        <br />
