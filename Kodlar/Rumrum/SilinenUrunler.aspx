<%@ Page Title="" Language="C#" MasterPageFile="~/Rumrum/MasterPage.master" AutoEventWireup="true" CodeFile="SilinenUrunler.aspx.cs" Inherits="Rumrum_SilinenUrunler" %>
            ...
            <section id="main" class="column">
                ...
                <article class="module width_full">
                    ...
                    <div class="module_content">
                        <div id="AramaKriter_Div" style="margin-bottom: 5px;">
                        ...
                        <table style="width: 960px" border="0" cellpadding="0" cellspacing="1" class="GridviewTable">
                            ...
                            <tr>
                                <td colspan="7">
                                    <asp:GridView ID="Urunler_Grid" runat="server" AutoGenerateColumns="False" AllowPaging="True" PageSize="25" OnPageIndexChanging="Urunler_Grid_PageIndexChanging" DataKeyNames="UrunID" CssClass="Gridview" ShowHeader="false" OnRowDataBound="Urunler_Grid_RowDataBound" OnRowCommand="Urunler_Grid_RowCommand">
                                        <Columns>
                                            ...
                                            <asp:TemplateField ItemStyle-Width="120px">
                                                <ItemTemplate>
                                                    <asp:LinkButton ID="KapatBtn" runat="server" Text="Geri Al"
                                                        ToolTip="Ürünü Ger Al" CommandArgument='<%# Eval("UrunID")%>' CommandName="GeriAl">
                                                    </asp:LinkButton>
                                                    <asp:ConfirmButtonExtender
                                                        ID="ConfirmButtonExtender1" runat="server" TargetControlID="KapatBtn" ConfirmText="Ürünü geri almak istediğinize emin misiniz ?">
                                                    </asp:ConfirmButtonExtender>
                                                    ...
                                                    <asp:Panel ID="pnlPopup" runat="server" CssClass="modalPopup" Style="display: none">
                                                        ...
                                                        <div class="body">
                                                            <div id="AnaDiv" style="width: 700px; height: 225px; float: left;">
                                                                <div id="Logodiv" style="width: 160px; height: 220px; float: left;">
                                    ...
                                    <h4 id="Alt_GridKayitYokDiv" runat="server" class="alert_warning" visible="false">Silinen Ürün Bulunamadı !</h4>
                                    <br />
                                </td>
                            </tr>
                        </table>
