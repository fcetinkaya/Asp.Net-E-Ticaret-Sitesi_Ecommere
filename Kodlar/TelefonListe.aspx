<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="TelefonListe.aspx.cs" Inherits="TelefonListe" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <asp:UpdatePanel ID="Kategori_Update" runat="server">
        <ContentTemplate>
            ...
            <div class="UrunListesiDiv">
                <asp:DataList ID="KategoriRepeater" runat="server" OnItemCommand="KategoriRepeater_ItemCommand" OnItemDataBound="KategoriRepeater_ItemDataBound" RepeatDirection="Horizontal" Width="980px" RepeatColumns="4">
                    <ItemTemplate>
