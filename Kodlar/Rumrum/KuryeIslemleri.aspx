<%@ Page Title="" Language="C#" MasterPageFile="~/Rumrum/MasterPage.master" AutoEventWireup="true" CodeFile="KuryeIslemleri.aspx.cs" Inherits="Rumrum_KuryeIslemleri" %>
        ...
        <asp:UpdatePanel ID="UpdatePanel1" runat="server">
            <ContentTemplate>
                ...
                <article class="module width_full">
                    <header>
                        <h3>yeni kurye kayıt işlemi</h3>
                    </header>
                    <div class="module_content" style="height: 220px;">
                        <fieldset style="width: 48%; float: left;">
                            <label class="labelfiel">
                                firma adı</label>
                            <asp:TextBox ID="FirmaAdi_Box" runat="server" CssClass="textfield" Width="410px"></asp:TextBox>

                            <asp:RequiredFieldValidator ID="Required_Kayit_1" runat="server" ErrorMessage="Lütfen firma adını yazınız."
                                Display="None" ControlToValidate="FirmaAdi_Box" ValidationGroup="Kargo"></asp:RequiredFieldValidator>
                        ...
                        <fieldset style="width: 48%; float: left; margin-left: 1%;">
                            <label class="labelfiel">Açıklama</label>
                            <asp:TextBox ID="AciklamaBox" runat="server" CssClass="textfield" Width="410px" MaxLength="300" Text="Sipariş ettiğiniz ürün kurye firmasına teslim edilmiştir."></asp:TextBox>
                            <asp:RequiredFieldValidator ID="Required_Kayit_2" runat="server" ErrorMessage="Lütfen açıklama yazınız."
                                Display="None" ControlToValidate="AciklamaBox" ValidationGroup="Kargo"></asp:RequiredFieldValidator>
                        ...
                        <footer>
                            <div class="submit_link">
                                <asp:Button ID="KargoEkleBtn" runat="server" Text="Kurye Kaydet" CssClass="alt_btn" ValidationGroup="Kargo" OnClick="KargoEkleBtn_Click" />
                            </div>
                        </footer>
                        <br />
                        <br />
                ...
                <article class="module width_full">
                    ...
                    <div class="module_content">
                        ...
                        <div id="AramaPopup" class="AramaKriteri_Small_Yukseklik">
                            ...
                            <div class="AramaKriteri_body">
                                <fieldset>
                                    <label class="labelfiel">
                                        firma adı</label>
                                    <asp:TextBox ID="Ara_FirmaAdiBox" runat="server" CssClass="textfield"></asp:TextBox>
                                </fieldset>
                                <div class="clear"></div>
                                <fieldset style="width: 48%; float: left;">
                                    <label class="labelfiel">müşteri adı soyadı</label>
                        ...
                        <table style="width: 955px" border="0" cellpadding="0" cellspacing="1"
                            class="GridviewTable">
                            <tr>
                                <td style="width: 145px;">FİRMA ADI
                                </td>
                            ...
                            <tr>
                                <td colspan="5">
                                    <asp:GridView ID="KargoListesi_Grid" runat="server" AutoGenerateColumns="False" AllowPaging="True" OnPageIndexChanging="KargoListesi_Grid_PageIndexChanging" CssClass="Gridview" ShowHeader="false" PageSize="20" OnRowDataBound="KargoListesi_Grid_RowDataBound" OnRowCommand="KargoListesi_Grid_RowCommand">
                                        <Columns>
                                            ...
                                            <asp:TemplateField ItemStyle-Width="100px">
                                                <ItemTemplate>
                                                    <asp:ImageButton ID="DuzenleBtn" runat="server" ImageUrl="~/Rumrum/images/icn_edit.png" ToolTip="Düzenle" CommandArgument='<%#Eval ("E_KuryeTakipID") %>' OnClick="DuzenleBtn_Click" />
                                                    &nbsp;&nbsp;<asp:ImageButton ID="SilBtn" runat="server" ImageUrl="~/Rumrum/images/icn_trash.png"
                                                        ToolTip="Kurye İşlemini Sil" CommandArgument='<%#Eval ("E_KuryeTakipID") %>' CommandName="Sil" /><asp:ConfirmButtonExtender
                ...
                <asp:Panel ID="pnlPopup" runat="server" CssClass="modalPopup" Style="display: none">
                    ...
                    <div class="body">
                        <div id="BilgilerDiv" style="width: 330px; height:300px; float: left; margin-left: 10px;">
                            <div style="width: 130px; height: 20px; float: left;">
                                <b>Firma Adı :</b>
                            </div>
                            <div style="width: 200px; height: 30px; float: left;">
                                <asp:TextBox ID="Guncelle_FirmaAdiBox" runat="server" CssClass="textfield" Width="200px"></asp:TextBox>
                                <asp:RequiredFieldValidator ID="Required_Gun_1" runat="server" ErrorMessage="Lütfen firma adını yazınız."
                                    Display="None" ControlToValidate="Guncelle_FirmaAdiBox" ValidationGroup="KargoGuncelle"></asp:RequiredFieldValidator>
                            ...
                            <div style="width: 200px; height: 200px; float: left;">
                                <asp:TextBox ID="Guncelle_AciklamaBox" runat="server" CssClass="textfield" Width="200px" Height="200px" TextMode="MultiLine"></asp:TextBox>
                                <asp:RequiredFieldValidator ID="Required_Gun_2" runat="server" ErrorMessage="Lütfen numarayı yazınız."
                                    Display="None" ControlToValidate="Guncelle_AciklamaBox" ValidationGroup="KargoGuncelle"></asp:RequiredFieldValidator>
                            ...
                            <div style="width: 200px; height: 30px; float: left;">
                                ...
                                <asp:RequiredFieldValidator ID="Required_Gun_4" runat="server" ErrorMessage="Lütfen sipariş numarasını yazınız."
                                    Display="None" ControlToValidate="Guncelle_MusteriAdBox" ValidationGroup="KargoGuncelle"></asp:RequiredFieldValidator>
                                <asp:ValidatorCalloutExtender ID="Validator_Gun_4" runat="server" TargetControlID="Required_Gun_4"
                                    PopupPosition="BottomLeft">
                                </asp:ValidatorCalloutExtender>
                            </div>
                        </div>
