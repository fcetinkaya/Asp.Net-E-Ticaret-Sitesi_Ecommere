...
{
    cls_KategoriListe Kat_Cls = new cls_KategoriListe();
    cls_Urunler_CokSatanlar Urun_Cls = new cls_Urunler_CokSatanlar();
    SqlConnection con = new SqlConnection();
    private static string GelenID, Secim;
    public int SayfaNo
    {
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            try
            {
                ...
                {
                    string Raute = RouteData.Values["KatAdi"].ToString();
                    string[] GelKAt = Kat_Cls.Ana_KategorilerBilgisiGetir(Raute);
    ...
    protected void KampanyaEpostaBtn_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            if (Session["E_ticaretim"] != null)
            {
                string Aciklama = RouteData.Values["KatAdi"].ToString() + " Kategorisi için Talep Var.";
