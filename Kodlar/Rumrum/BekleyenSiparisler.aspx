<%@ Page Title="" Language="C#" MasterPageFile="~/Rumrum/MasterPage.master" AutoEventWireup="true" CodeFile="BekleyenSiparisler.aspx.cs" Inherits="Rumrum_BekleyenSiparisler" %>
        ...
        <ContentTemplate>
            <section id="main" class="column">
                ...
                <article class="module width_full">
                    <header>
                        <h3>bekleyen siparişler listesi {<asp:Label ID="ToplamAdetLbl" runat="server"></asp:Label>}</h3>
                    </header>
